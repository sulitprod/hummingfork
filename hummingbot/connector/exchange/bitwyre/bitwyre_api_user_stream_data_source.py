...
from hummingbot.connector.exchange.bitwyre import bitwyre_constants as CONSTANTS
from hummingbot.connector.exchange.bitwyre.bitwyre_auth import BitwyreAuth
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.bitwyre.bitwyre_exchange import BitwyreExchange


class BitwyreAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self,
                 ...
                 connector: 'BitwyreExchange',
                 api_factory: WebAssistantsFactory,
                 domain: str = CONSTANTS.DEFAULT_DOMAIN):
        super().__init__()
        self._api_factory = api_factory
        self._auth: BitwyreAuth = auth
