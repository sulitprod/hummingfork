...
from hummingbot.connector.exchange.bitwyre_draft import bitwyre_constants as CONSTANTS, bitwyre_web_utils as web_utils
from hummingbot.connector.exchange.bitwyre_draft.bitwyre_api_order_book_data_source import BitwyreAPIOrderBookDataSource
from hummingbot.connector.exchange.bitwyre_draft.bitwyre_api_user_stream_data_source import BitwyreAPIUserStreamDataSource
from hummingbot.connector.exchange.bitwyre_draft.bitwyre_auth import BitwyreAuth
...
class BitwyreExchange(ExchangePyBase):
    ...
    def __init__(self,
        ...
        """
        self._bitwyre_api_key = bitwyre_api_key
        self._bitwyre_secret_key = bitwyre_secret_key
        self._domain = domain
    ...
    def authenticator(self):
        return BitwyreAuth(
            api_key=self._bitwyre_api_key,
            secret_key=self._bitwyre_secret_key,
    ...
    def _create_order_book_data_source(self) -> OrderBookTrackerDataSource:
        return BitwyreAPIOrderBookDataSource(
    ...
    def _create_user_stream_data_source(self) -> UserStreamTrackerDataSource:
        return BitwyreAPIUserStreamDataSource(
            auth=self._auth,
            trading_pairs=self._trading_pairs,
            connector=self,
            api_factory=self._web_assistants_factory,
